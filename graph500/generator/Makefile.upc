...
generator_test_upc: generator_test_upc.c libgraph_generator_upc.a
	$(MPICC) $(CFLAGS) $(LDFLAGS) -o generator_test_upc generator_test_upc.c -L. -lgraph_generator_upc -lm

libgraph_generator_upc.a: btrd_binomial_distribution.o splittable_mrg.o mrg_transitions.o graph_generator.o permutation_gen.o apply_permutation_upc.o make_graph.o utils.o scramble_edges.o
	$(AR) cruv libgraph_generator_upc.a btrd_binomial_distribution.o splittable_mrg.o mrg_transitions.o graph_generator.o permutation_gen.o apply_permutation_upc.o make_graph.o utils.o scramble_edges.o
...
make_graph.o: make_graph.c splittable_mrg.h mod_arith.h btrd_binomial_distribution.h graph_generator.h make_graph.h permutation_gen.h utils.h scramble_edges.h apply_permutation_upc.h
	$(MPICC) $(CFLAGS) -c make_graph.c

apply_permutation_upc.o: apply_permutation_upc.c splittable_mrg.h mod_arith.h btrd_binomial_distribution.h graph_generator.h make_graph.h permutation_gen.h utils.h apply_permutation_upc.h
	$(MPICC) $(CFLAGS) -c apply_permutation_upc.c
