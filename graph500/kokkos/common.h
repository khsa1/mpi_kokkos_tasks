...
int validate_bfs_result(const csr_graph* const g, const int64_t root, const int64_t* const pred); /* In validate.c */

void run_mpi_bfs(const csr_graph* const g, int64_t root, int64_t* pred); /* Provided by user */
